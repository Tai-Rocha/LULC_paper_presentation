...
- Important predictors of species occurrence

- One of the main drivers of environmental change at multiple scales

- Ecological niche models (as predictor or pos processing analysis)

- Ecosystem services (InVEST modeling tool)

--

## Thus...
Mapping land-use land-cover (LULC) changes through time is, therefore, important and desirable to predict these threats and propose effective conservation policies

---
## Motivation
##### Many products. But there is gap of time series that covers... . 

---
## Motivation 
#### Fell products ... Just two cover a large time series
> Luh2
...
#### Make the LUh2 more acessible (particulaly for ecoloist and biogeographer) 

#### Derive a new categorical data  (ecossystem servise) 🚀

...
---
## Land-use land-cover (LULC)
- [Important predictors of species occurrence](#pre-requisitos)

- [One of the main drivers of environmental change at multiple scales](#projetos-rstudio)

--
## Thus...
Mapping land-use land-cover (LULC) changes through time is, therefore, important and desirable to predict these threats and propose effec tive conservation policies
---
...
## Land-use land-cover (LULC)
- [Ecological niche models (as predictor or pos processing analysis)](#pre-requisitos)

- [Ecosystem services (InVEST modeling tool)](#projetos-rstudio)
---
class: middle
